          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="team-member">
              ...
              <div class="p-3 bg-primary">
                ...
                <span class="position">Stockiest</span>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-4 text-center">
            <div class="pr-5 first-step">
              ...
              <h3 class="text-black">Stock Product.</h3>
          ...
          <div class="col-md-4 text-center">
            <div class="pr-5">
              ...
              <h3 class="text-dark">Find Product.</h3>
              <p class="text-black">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            </div>
          </div>
          ...
          <div class="col-md-4 text-center">
            <div class="pr-5 second-step">
              ...
              <h3 class="text-dark">Buy Product.</h3>
              <p class="text-black">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            </div>
          </div>
        ...
        <div class="row large-gutters">
          <div class="col-lg-6 mb-5">
              ...
              <div class="owl-carousel slide-one-item with-dots">
                  <div><img src="images/1.jpg" alt="Free website template by Free-Template.co" class="img-fluid"></div>
                  <div><img src="images/2.jpg" alt="Free website template by Free-Template.co" class="img-fluid"></div>
                  <div><img src="images/3.jpg" alt="Free website template by Free-Template.co" class="img-fluid"></div>
                </div>

          </div>
          <div class="col-lg-6 ml-auto">
            
            <h2 class="section-title mb-3">Fulfill customer demand</h2>
